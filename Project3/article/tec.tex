...
\begin{figure}[h]
     ...
     \begin{subfigure}[b]{0.46\textwidth}
        \centering
    \includegraphics[width=\textwidth]{figures/results/predictions/b_s_recon_big_rm3feats_allsig_nolog.pdf}
    ...
    \label{fig:s_b_big_pred_allsig}
     ...
     \begin{subfigure}[b]{0.46\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/results/rocs/b_s_roc_curve_big_rm3feats_allsig.pdf}
...
\begin{figure}[h]
     ...
     \begin{subfigure}[b]{0.46\textwidth}
        \centering
    \includegraphics[width=\textwidth]{figures/results/predictions/b_s_recon_small_rm3_feats_nogmumu_nolog.pdf}
    ...
    \label{fig:s_b_small_pred_}
     ...
     \begin{subfigure}[b]{0.46\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/results/rocs/b_s_roc_curve_small_nogmumu.pdf}
...
\begin{figure}[h]
     ...
     \begin{subfigure}[b]{0.46\textwidth}
        \centering
    \includegraphics[width=\textwidth]{figures/results/predictions/b_s_recon_big_rm3_feats_rmmanyfeats_loglog.pdf}
    \caption{Reconstruction error of background MC and signal MC for small auto encoder. }
    \label{fig:s_b_big_pred_13}
     ...
     \begin{subfigure}[b]{0.46\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/results/rocs/b_s_roc_curve_big_rmmanyfeats.pdf}
         \caption{ROC curve signal MC and background MC for small auto encoder}
...
\begin{figure}[h]
     ...
     \begin{subfigure}[b]{0.46\textwidth}
        \centering
    \includegraphics[width=\textwidth]{figures/results/predictions/b_s_recon_big_rm3_feats_standard_propsigbacksplit_nolog_allsig_nogmumu.pdf}
    \caption{Reconstruction error of background MC and signal MC for big auto encoder. }
    \label{fig:s_b_big_pred_stand}
     ...
     \begin{subfigure}[b]{0.46\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/results/rocs/b_s_roc_curve_big_standard_allsig_nogmumu.pdf}
         \caption{ROC curve signal MC and background MC for big auto encoder}
