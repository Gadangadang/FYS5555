...
\end{figure}
The grid search gave the optimal hyper parameters as follows: the encoder has the following activation functions: BLANK, BLANK, BLANK, BLANK, and the decoder has the following activation functions: BLANK, BLANK, BLANK and BLANK. The optimal learning rate was BLANK, the optimal kernel regularizer was BLANK, the optimal activity regularizer was BLANK and the optimal alpha for the leakyReLU was BLANK. \par 


\begin{figure}[H]
     \centering
         \includegraphics[width=0.46\textwidth]{figures/results/predictions/b_data_recon_big_rm3_feats.pdf}
         \caption{Histogram showing reconstruction error for ATLAS data and background MC for big auto encoder. Y scale is in units of 1e6.}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.46\textwidth}
        \centering
    \includegraphics[width=\textwidth]{figures/results/predictions/b_s_recon_big_rm3_feats.pdf}
    \caption{Reconstruction error of background MC and signal MC for big auto encoder. Y scale is in units 1e7. }
    \label{fig:s_b_big_pred}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.46\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/results/rocs/b_s_roc_curve_big_rm3feats.pdf}
     ...
     \end{subfigure}
        ...
        \label{fig:roc_sig_big}
\end{figure}

%In figure \ref{fig:s_b_big_pred} we observe the prediction of signal MC against background MC. It is clear that the algorithm manages to separate the two datasets, creating two separate distributions. This is further supported by the ROC curve in figure \ref{fig:s_b_big_roc}, which gives a AUC of 0.761.\par 
\\
To compare this architecture I created a smaller auto encoder, shown in figure \ref{fig:small_ae_plot}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.46\textwidth]{figures/results/models/ae_model_plot_small_3rmfeats.pdf}
...
\begin{figure}[H]
     \centering
         \includegraphics[width=0.46\textwidth]{figures/results/predictions/b_data_recon_small_3rmfeats.pdf}
         \caption{Histogram showing reconstruction error for ATLAS data and background MC for small auto encoder. Y scale is in units of 1e6.}
     \label{fig:data_b_big_pred}
\end{figure}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.46\textwidth}
        \centering
    \includegraphics[width=\textwidth]{figures/results/predictions/b_s_recon_small_3rmfeats.pdf}
    \caption{Reconstruction error of background MC and signal MC for small auto encoder. Y scale is in units 1e7. }
    \label{fig:s_b_big_pred}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.46\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/results/rocs/b_s_roc_curve_small_3rmfeats.pdf}
